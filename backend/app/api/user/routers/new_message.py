...
async def create_message(
    ...
    schedule_telegram_message.apply_async(kwargs={"user_id": user.id, "msg_id": new_msg.id}, eta=msg.end_send_date)
    if msg.start_date:
        schedule_telegram_message.apply_async(kwargs={"user_id": user.id, "msg_id": new_msg.id}, eta=msg.start_send_date)
